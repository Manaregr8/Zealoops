...
<section>
    <p>
        This document is an electronic record as contemplated under section 2(t)
        of the Information Technology Act, 2000 and the rules thereunder.
    </p>
    <p>
        ...
        DELHI-110059. <br><br>This document (together with the documents mentioned
        ...
        (hereinafter referred to as the "Conditions").<br><br>For the purpose of this
        ...
        Website in any way.<br><br>We urge the Users to read the Conditions, our
        ...
        Data Protection Policies.<br><br>Accessing, browsing or otherwise using the
    ...
    <p>
        ...
        so through their legal guardian in compliance with applicable laws.<br><br>If a
        ...
        authorization of that entity to do so.<br><br>The Company retains the right to
    ...
    <p>
        ...
        completeness of all information provided during registration.<br><br>If the
        ...
        provided information is true and accurate.<br><br>Each User is permitted to
    ...
    <p>
        ...
        agrees to the following:<br><br>a. To use this Website solely for making
        legitimate inquiries and orders. <br><br>b. To refrain from placing any false or
        ...
        the appropriate authorities. <br><br>c. To provide the Company with accurate and
        ...
        (Refer to the Privacy Policy).<br><br>d. User agrees to receive communications
    ...
    <p>
        ...
        shall be strictly limited to the price of said product.<br><br>Given the open
        ...
        unless expressly stated otherwise on the website. <br><br>All product
    ...
    <li>
        Match the description provided by us and possess the qualities presented
        on this website;
    </li>
    <li>
        Are suitable for the purposes for which goods of this kind are typically
        used;
    </li>
    <li>
        Exhibit the quality and performance that are standard in goods of the
    ...
    <p>
        The Company shall not be held accountable for any direct, indirect,
    ...
    <h5>6. VIRUSES, PIRACY AND OTHER COMPUTER ATTACKS</h5>
    <p>
    ...
    <h5>7. LINKS FROM OUR WEBSITE</h5>
    <p>
    ...
    <p>
        ...
        Terms and Conditions.<br><br>It is understood that our contractual obligations
    ...
    <li>
        Breach of any representations, warranties, or covenants made by the
        User;
    </li>
    <li>
        Violation of the policies, guidelines, and conditions of the Company’s
        service, or these Conditions or Privacy Policy (including any
        modifications, additional notifications, or instructions);
    </li>
    <li>
        Infringement of any third-party rights. This provision remains valid
        even after the conclusion or cancellation of a transaction on the
        Website or the removal or termination of these Conditions.
    </li>
    ...
    <p>
        ...
        provided through the Website by closing their User Account. <br><br>Upon
        ...
        Company.<br><br>Following the conclusion or cancellation of a transaction or
    ...
    <h5>12. GRIEVANCE, COMMENTS, FEEDBACK AND SUGGESTIONS</h5>
    <p>
        For any grievances/ comments / feedback / suggestions / queries, the
        User may write to us.
    </p>
    <p>
        Email: <a href="mailto:info@zealoops.com">info@zealoops.com</a><br />
